i want to add  this funtinality in my page <?php
            ...
            <div class="col-md-10 main-content">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12 col-md-4 d-flex justify-content-md-end align-items-start">
                                <div class="d-flex gap-2 mt-2 mt-md-0 flex-wrap">
                                    ...
                                    <a href="student_admission.php" class="btn btn-sm btn-success d-flex align-items-center">
                ...
                <section id="student-management" class="section" style="display: none;">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="student_admission.php" class="btn btn-success">
                ...
                <script>
                    ...
                    function validateAdmissionForm() {
                        let isValid = true;
                        const requiredFields = ['first_name', 'last_name', 'email', 'phone', 'dob',
                            'gender', 'address', 'Course', 'parent_name',
                            'parent_phone', 'institute_name', 'Admission_code', 'status'
                        ];
                        ...
                        phoneFields.forEach(field => {
                            const element = document.querySelector(`[name="${field}"]`);
                            if (element && !/^\d{10}$/.test(element.value)) {
                                element.classList.add('is-invalid');
                                isValid = false;
                            }
                        });
                    ...
                    document.querySelectorAll('#studentAdmissionForm input, #studentAdmissionForm select').forEach(element => {
                    ...
                    document.getElementById('admissionModal')?.addEventListener('hidden.bs.modal', function() {
                    ...
                    document.getElementById('addInstituteModal')?.addEventListener('hidden.bs.modal', function() {
                        document.getElementById('addInstituteForm')?.reset();
                    });
